...
STATE_CHOICES = (("Andhra Pradesh", "Andhra Pradesh"), ("Arunachal Pradesh ", "Arunachal Pradesh "),
                 ...
                 ("West Bengal", "West Bengal"), ("Andaman and Nicobar Islands",
...
class Customer(models.Model):
    ...
    state = models.CharField(choices=STATE_CHOICES, max_length=75)
